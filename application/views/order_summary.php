                    ...
                    <?php
                    	if(count($payment) >0) {
                    		...
                    		<li>
		                            ...
		                            <strong><?php if($payment[0]->status ==1) {echo 'Razopray';}else if($payment[0]->status ==2) {echo 'COD';}?></strong>
		                        </li>
                    		<?php
                    	}
                    ?>
                            	...
                            	if(count($orderproducts)) {
                            		foreach ($orderproducts as $key => $value) {
                            			?>
                            			    <tr>
			                                    <td>
			                                        <a href="<?= base_url().'products/'.$value->purl;?>"><?= $value->name;?></a>&nbsp;<strong>x <?= $value->qty;?></strong></a>
			                                    </td>
			                                    <td><i class="fas fa-rupee-sign"></i> <?= number_format($value->price);?></td>
		                                	</tr>
                            			<?php
                            		}
                            	}
                                ...
                                <?php
                                    if(!empty($orders[0]->taxamount) && $orders[0]->taxamount !=0) {
                                        ?>  
                                         <tr>
                                            <th>Tax:</th>
                                            <td><i class="fas fa-rupee-sign"></i> <?= number_format($orders[0]->taxamount,2);?></td>
                                        </tr>
                                        <?php
                                    }
                                ?>
